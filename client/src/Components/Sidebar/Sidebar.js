  ...
  return (
    <>
      ...
      <aside
        ...
        style={{ position: "fixed", backgroundColor: "#00695c", color: "#fff" }}
      >
        {/* <!-- Brand Logo --> */}
        <Link to="/dashboard" className="brand-link">
          <div
            className="d-flex align-items-center justify-content-center  elevation-1 rounded  p-2 "
        ...
        <div className="sidebar">
          ...
          {/* <div className="user-panel mt-3 pb-1 mb-2 d-flex">
            <div className="info text-decoration-none border-bottom-0 w-100">
              <Link
                to="/dashboard"
                className="d-block text-white w-100 text-center   font-weight-bold text-lg"
              >
                Human Resource
              </Link>
            </div>
            ...
            >
              ...
              <li className="nav-item">
                <Link to="/dashboard" className="nav-link">
                  ...
                  <p className="iconColor">Dashboard</p>
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/companies" className="nav-link">
                  <i className="nav-icon fas fa-tachometer-alt iconColor"></i>
                  <p className="iconColor">Companies</p>
                </Link>
              </li>
              {/* {context.user.role ==='HR' || context.user.role === 'CEO' && */}

              <li className="nav-item">
                <Link to="/employees" className="nav-link">
                  <i className="nav-icon fa-solid fa-user iconColor"></i>

                  <p className="iconColor">Employees</p>
                </Link>
              </li>
              {/* } */}

              {context.user.role === "HR" && (
                <li className="nav-item">
                  <Link to="/departments" className="nav-link">
                    <i className="nav-icon fa-solid fa-user iconColor"></i>

                    <p className="iconColor">Departments</p>
                  </Link>
                </li>
              )}
              <li className="nav-item">
                <Link to="/positions" className="nav-link">
                  ...
                  <p className="iconColor">Positions</p>
                </Link>
              </li>
              ...
              >
                <a className="nav-link" style={{ cursor: "pointer" }}>
                  ...
                  <i
                    className="nav-icon fa-solid fa-chevron-down iconColor"
                    style={{ fontSize: "13px" }}
                  ></i>
                  {toggleLeaves && (
                    <>
                      <Link to={"/leaverequest"} className="nav-link ">
                        <i
                          class="fa-solid fa-angle-right iconColor nav-icon"
                          style={{ fontSize: "13px" }}
                        ></i>
                      ...
                      <Link to="/leaves" className="nav-link">
                        ...
                        <p className="iconColor">Leave Types</p>
                      </Link>
                      <Link to="/leavesettings" className="nav-link">
                        <i
                          class="fa-solid fa-angle-right iconColor nav-icon"
                          style={{ fontSize: "13px" }}
                        ></i>

                        <p className="iconColor">Leaves Settings</p>
                      </Link>
                    </>
                  )}
                </a>
              ...
              <li className="nav-item">
                <Link to="/attendance" className="nav-link">
                  <i className="nav-icon fas fa-tachometer-alt iconColor"></i>
                  <p className="iconColor">Attendance</p>
                </Link>
              </li>
              ...
              <li
                className="nav-item"
                onClick={() => {
                  settoggleAttendance(!toggleAttendance);
                }}
              >
                <a className="nav-link" style={{ cursor: "pointer" }}>
                  <div className="d-flex">
                    ...
                    <i
                      className="nav-icon fa-solid fa-chevron-down iconColor my-3"
                      style={{ fontSize: "13px" }}
                    ></i>
                  </div>
                  {toggleAttendance && (
                    <>
                      <Link to="/datamanagement" className="nav-link">
                        ...
                        <p className="iconColor">Reports</p>
                      </Link>
                      <Link to="/monthlyattendance" className="nav-link">
                        ...
                        <p className="iconColor">History</p>
                      </Link>
                    </>
                  )}
                </a>
              ...
              <li className="nav-item">
                <Link to="/monthlypayroll" className="nav-link">
                  ...
                  <p className="iconColor">Monthly Payroll</p>
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/payrollsetup" className="nav-link">
                  ...
                  <p className="iconColor">PayRoll Setup</p>
                </Link>
              </li>
              {/* <li className="nav-item">
                <Link to="/employeeData" className="nav-link">
                  <i className="nav-icon fas fa-tachometer-alt iconColor" ></i>
